...
namespace DCXR
{
	public class IniFile
	{
		...
		// get vector
		public Vector3 Get_Vector2(string name, Vector2 defaultValue)
		{
		...
		public void Set_Strings(string name, string[] value, string comment = "")
		{
			string line = "";
		...
		public void SaveTo(string fileName)
		{
			...
			foreach (string key in keys)
			{
				...
				List<string> pairs = new List<string>(s.pairs.Keys);
				// pairs.Sort();
